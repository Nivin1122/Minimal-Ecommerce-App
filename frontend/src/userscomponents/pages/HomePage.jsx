          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/cart" className="text-gray-400 hover:text-white transition-colors duration-200">Cart</Link></li>
                <li><Link to="/user/orders" className="text-gray-400 hover:text-white transition-colors duration-200">Orders</Link></li>
              </ul>
            </div>
